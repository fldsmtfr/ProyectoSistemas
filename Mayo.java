...
public class Mayo extends JFrame implements ActionListener{
  private JLabel l1;
  ...
  public Mayo(){
    ...
    l1=new JLabel("Mayonese"); //etiqueta
    l1.setBounds(40,20,100,30);
    add(l1);
    ShowVotes finalvotes=new ShowVotes();
    
	//muestra datos sobre la mayonesa
    ta1=new JTextArea("Ingredients: milk,soy,vinegar,artificial colorants. \n"+
			"Spicy:0 \n"+
			"Votes:"+finalvotes.mscore+"/10");
    ta1.setBounds(40,60,300,100);
    add(ta1);
   
    cb1=new JComboBox(); //muestra las opciones de las porciones
    ...
    b1=new JButton("add"); //boton para agregar porcion
    b1.setBounds(160,240,80,30);
    b1.addActionListener(this);
    add(b1);
 
    b2=new JButton("back"); //boton para volver
    ...
    archivo=new File("C:\\Users\\HP\\Documents\\septimo\\SISTEMAS\\Proyectoeval\\mayoconsume.txt");
	try{
  ...
  public void actionPerformed(ActionEvent e){
    if(e.getSource()==b2){ //regresa a la interfaz de cliente
    ...
    if(e.getSource()==b1){ 
     ...
     this.mayocounter(addedportion);
      Salida trysal=new Salida(portion,salsa); //muestra la salida: porcion agregada y tipo de salsa
	...
	fr=null;
	    	try{
	     	 BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\HP\\Documents\\septimo\\SISTEMAS\\Proyectoeval\\mayoconsume.txt"));
	      	 bw.write("");
   ...
   public void mayocounter(int addedportion){ //leemos el restante de salsa de un archivo externo .txt
	...
	System.out.println("Se han usado "+counter+" grs de Mayo, quedan "+resto);
